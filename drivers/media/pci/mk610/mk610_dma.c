...
static void axi_pci_trans(struct mk610_dev *dev)
{
    ...
    pci_write (MK610_PCIE_BASE, AXIBAR2PCIEBAR_0L, (pntr0 >> 0)  & 0xFFFFFFFF); // Lower 32 bit
    pci_write (MK610_PCIE_BASE, AXIBAR2PCIEBAR_0U, (pntr0 >> 32) & 0xFFFFFFFF); // Upper 32 bit
    pci_write (MK610_PCIE_BASE, AXIBAR2PCIEBAR_1L, (pntr1 >> 0)  & 0xFFFFFFFF); // Lower 32 bit
    pci_write (MK610_PCIE_BASE, AXIBAR2PCIEBAR_1U, (pntr1 >> 32) & 0xFFFFFFFF); // Upper 32 bit	
